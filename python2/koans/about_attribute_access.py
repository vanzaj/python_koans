...
class AboutAttributeAccess(Koan):
    ...
    def test_calling_undefined_functions_normally_results_in_errors(self):
        ...
        try:
            ...
            msg = "'TypicalObject' object has no attribute 'foobar'"
            self.assertMatch(msg, exception[0])
    ...
    def test_all_attribute_reads_are_caught(self):
        ...
        msg = "Someone called 'foobar' and it could not be found"
        self.assertMatch(msg, catcher.foobar)

    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        catcher = self.CatchAllAttributeReads()

        msg = "Someone called 'foobaz' and it could not be found"
        self.assertMatch(msg, catcher.foobaz)  # This is fine

        try:
            catcher.foobaz(1)
        except TypeError as ex:
            msg = "'str' object is not callable"
            self.assertMatch(msg, ex[0])
    ...
    def test_changing_getattribute_will_affect__the_getattr_function(self):
        ...
        msg = "Someone called 'any_attribute' and it could not be found"
        self.assertMatch(msg, getattr(catcher, 'any_attribute'))
    ...
    def test_non_foo_messages_are_treated_normally(self):
        ...
        try:
            ...
            msg = "'WellBehavedFooCatcher' object has no attribute 'normal_undefined_attribute'"
            self.assertMatch(msg, ex[0])
