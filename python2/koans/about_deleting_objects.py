...
class AboutDeletingObjects(Koan):
    ...
    def test_del_can_remove_entire_lists(self):
        ...
        try:
            ...
            pass
        msg = "local variable 'lottery_nums' referenced before assignment"
        self.assertMatch(msg, e[0])
    ...
    def test_del_can_remove_attributes(self):
        ...
        msg1 = "'ClosingSale' object has no attribute 'toilet_brushes'"
        msg2 = "'ClosingSale' object has no attribute 'hamsters'"
        self.assertMatch(msg1, err_msg1)
        self.assertMatch(msg2, err_msg2)
